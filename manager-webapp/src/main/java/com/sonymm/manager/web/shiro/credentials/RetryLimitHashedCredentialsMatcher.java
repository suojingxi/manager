package com.sonymm.manager.web.shiro.credentials;
...
public class RetryLimitHashedCredentialsMatcher extends HashedCredentialsMatcher {
    ...
    public String buildCredentials(String userName, String password, String credentialsSalt){
        SimpleAuthenticationInfo simpleAuthenticationInfo = new SimpleAuthenticationInfo(userName, password, ByteSource.Util.bytes(userName + credentialsSalt), userName);
        AuthenticationToken token = new UsernamePasswordToken(userName, password);
        return super.hashProvidedCredentials(token, simpleAuthenticationInfo).toString();
    }
}
